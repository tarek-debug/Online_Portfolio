$(document).ready(function() {
  ...
  function saveChanges() {
    ...
    var story_writing_main_title = $('#story_writing_main_title').html();
    var story_writing_main_intro = $('#story_writing_main_intro').html();
  
    // Create a FormData object and append the data
    var formData = new FormData();
    formData.append('story_writing_main_title', story_writing_main_title);
    formData.append('story_writing_main_intro', story_writing_main_intro);
  
    console.log(story_writing_main_title);
    console.log(story_writing_main_intro);
    // Send the data to the server using AJAX
    $.ajax({
      url: "/edit_stories_main_page_text",  // Endpoint that handles the update in Flask
      method: 'POST',
      data: formData,
      processData: false,
      contentType: false,
