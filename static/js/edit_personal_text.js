...
function saveChanges() {
  ...
  var personal_projects_main_title = $('#personal_projects_main_title').html();
  var personal_projects_main_intro = $('#personal_projects_main_intro').html();

  // Create a FormData object and append the data
  var formData = new FormData();
  formData.append('personal_projects_main_title', personal_projects_main_title);
  formData.append('personal_projects_main_intro', personal_projects_main_intro);

  console.log(personal_projects_main_title);
  console.log(personal_projects_main_intro);
  // Send the data to the server using AJAX
  $.ajax({
    url: "/edit_personal_projects_page_text",  // Endpoint that handles the update in Flask
    method: 'POST',
    data: formData,
    processData: false,
    contentType: false,
