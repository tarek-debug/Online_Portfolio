...
function saveChanges() {
  ...
  var outdoor_title = $('#outdoor_title').html();
  var outdoor_introduction = $('#outdoor_introduction').html();
  var map_title = $('#map_title').html();
  // Create a FormData object and append the data
  var formData = new FormData();
  formData.append('outdoor_title', outdoor_title);
  formData.append('outdoor_introduction', outdoor_introduction);
  formData.append('map_title', map_title);
  console.log(outdoor_title);
  console.log(outdoor_introduction);
  // Send the data to the server using AJAX
  $.ajax({
    url: "/edit_outdoor_page_text",  // Endpoint that handles the update in Flask
    method: 'POST',
    data: formData,
    processData: false,
    contentType: false,
