$(document).ready(function() {
  ...
  function saveChanges() {
    ...
    var academic_main_title = $('#academic_main_title').html();
    var academic_projects_introduction = $('#academic_projects_introduction').html();

    // Create a FormData object and append the data
    var formData = new FormData();
    formData.append('academic_main_title', academic_main_title);
    formData.append('academic_projects_introduction', academic_projects_introduction);
    console.log(academic_main_title);
    console.log(academic_projects_introduction);
    // Send the data to the server using AJAX
    $.ajax({
      url: "/edit_academic_page_text",  // Endpoint that handles the update in Flask
      method: 'POST',
      data: formData,
      processData: false,
      contentType: false,
